...
const About: React.FC = () => {
  const content = [
    "Allo, je m’appelle Marianne et je suis designer UX/UI !",
    "Lors de mon parcours universitaire, j’ai développé une passion pour l’expérience utilisateur et la création d’interfaces, tout particulièrement dans le domaine du jeu vidéo. C’est d’ailleurs ce qui m’a poussée à travailler pour la refonte d’un jeu éducatif, d’entamer mon apprentissage de Unity et même de commencer mes propres projets de jeu. Toutes les étapes du processus de conception m’intéressent, allant de la recherche, l’élaboration de maquettes fonctionnelles jusqu’à l’intégration et l'entretien de systèmes de design.",
